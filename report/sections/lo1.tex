...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/plots/good_example_life_expectancy_japan.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/plots/bad_example_population_distribution_2007.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/plots/good_example_top10_gdp_2007.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/plots/good_example_life_exp_boxplot.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/plots/good_example_bubble_chart.png} 
